...
// - For other targets, the define needs to be visible from the ImGuiOpenGLRender.cpp compilation unit. If unsure, define globally or in imconfig.h.
...
//  2024-01-09: OpenGL: Update GL3W based ImGuiOpenGLRender_loader.h to load "libGL.so" and variants, fixing regression on distros missing a symlink.
//  2023-11-08: OpenGL: Update GL3W based ImGuiOpenGLRender_loader.h to load "libGL.so" instead of "libGL.so.1", accommodating for NetBSD systems having only "libGL.so.3" available. (#6983)
...
//  2021-08-19: OpenGL: Embed and use our own minimal GL loader (ImGuiOpenGLRender_loader.h), removing requirement and support for third-party loader.
...
//  2018-06-08: Misc: Extracted ImGuiOpenGLRender.cpp/.h away from the old combined GLFW/SDL+OpenGL3 examples.
...
// If you happen to be developing a new feature for this backend (ImGuiOpenGLRender.cpp):
// - You may need to regenerate ImGuiOpenGLRender_loader.h to add new symbols. See https://github.com/dearimgui/gl3w_stripped
//   Typically you would run: python3 ./gl3w_gen.py --output ../imgui/backends/ImGuiOpenGLRender_loader.h --ref ../imgui/backends/ImGuiOpenGLRender.cpp ./extra_symbols.txt
// - You can temporarily use an unstripped version. See https://github.com/dearimgui/gl3w_stripped/releases
// Changes to this backend using new APIs should be accompanied by a regenerated stripped loader version.
#define IMGL3W_IMPL
#define IMGUI_IMPL_OPENGL_LOADER_IMGL3W
#include "ImGuiOpenGLRender_loader.h"
#endif
